...
namespace QUAN_LI_CUA_HANG_DIEN_TU.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\QuanLiCuaHang.mdf;Integrated Security=True;User Instance=True";
            Con.Open();                  //Mở kết nối 
            //Kiểm tra kết nối
